...
$resultado = $conexion->datosMateria($id);
...
<body class="style">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
        <div class="dropdown">
            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Estudiantes</button>
        ...
        <div class="dropdown ml-auto">
            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">rayan ray</button>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <div class="justify-content-center">
        <div class="p-5 my-5">
            <div class="card">
                ...
                <form action="../copias/actualizar.php" method="POST">
                    <div class="p-5 justify-content-center">
                        <div class="form-group">
                            <label for="userId">Id</label>
                            <input value="<?= $idMateria ?>" required type="text" class="form-control" id="nombre" name="id" aria-describedby="emailHelp">
